export function SectionEmptyState({
  ...
  title: string;
  description: string;
  icon?: "folder" | "grid" | "quote";
}) {
  return (
    <div className="section-empty-state">
      <div className="section-empty-state-icon" aria-hidden>
        {icon === "quote" ? (
      ...
      <p className="section-empty-state-title">{title}</p>
      <p className="section-empty-state-desc">{description}</p>
    </div>
  );
}
